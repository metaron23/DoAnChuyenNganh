...
class CreateMonAn extends FormRequest
{
    ...
    {
        return [
            'ma_mon_an'             =>  'required|min:4|unique:mon_ans,ma_mon_an',
            'ten_mon_an'            =>  'required|min:5|unique:mon_ans,ma_mon_an',
            'slug_mon_an'           =>  'required|min:5|unique:mon_ans,ma_mon_an',
