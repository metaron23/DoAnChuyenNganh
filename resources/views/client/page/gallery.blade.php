            ...
            <div class="row portfolio__wrap mt--50">
                ...
                <div class="col-lg-7 pro__item cat--4 cat--2">
                    <div class="portfolio foo">
                        <img src="/assets_client/images/gallery/portfolio/1.jpg" alt="portfolio images">
                ...
                <div class="col-lg-5 pro__item cat--4 cat--1 cat--5">
                    <div class="portfolio foo">
                        <img src="/assets_client/images/gallery/portfolio/2.jpg" alt="portfolio images">
                        <div class="portfolio__hover">
                            <div class="portfolio__action">
                                <ul class="portfolio__list">
                ...
                <div class="col-lg-5 pro__item cat--4 cat--3 cat--5">
                    <div class="portfolio foo">
                        <img src="/assets_client/images/gallery/portfolio/3.jpg" alt="portfolio images">
                        <div class="portfolio__hover">
                            <div class="portfolio__action">
                                <ul class="portfolio__list">
                ...
                <div class="col-lg-7 pro__item cat--4 cat--2">
                    <div class="portfolio foo">
                        <img src="/assets_client/images/gallery/portfolio/4.jpg" alt="portfolio images">
                        <div class="portfolio__hover">
                            <div class="portfolio__action">
                                <ul class="portfolio__list">
                ...
                <div class="col-lg-7 pro__item cat--4 cat--1 cat--2 cat--5">
                    <div class="portfolio foo">
                        <img src="/assets_client/images/gallery/portfolio/5.jpg" alt="portfolio images">
                        <div class="portfolio__hover">
                            <div class="portfolio__action">
                                <ul class="portfolio__list">
                ...
                <div class="col-lg-5 pro__item cat--4 cat--3">
                    <div class="portfolio foo">
                        <img src="/assets_client/images/gallery/portfolio/6.jpg" alt="portfolio images">
                        <div class="portfolio__hover">
                            <div class="portfolio__action">
                                <ul class="portfolio__list">
                ...
                <div class="col-lg-5 pro__item cat--4 cat--2">
                    <div class="portfolio foo">
                        <img src="/assets_client/images/gallery/portfolio/7.jpg" alt="portfolio images">
                        <div class="portfolio__hover">
                            <div class="portfolio__action">
                                <ul class="portfolio__list">
                ...
                <div class="col-lg-7 pro__item cat--4 cat--1 cat--3 cat--5">
                    <div class="portfolio foo">
                        <img src="/assets_client/images/gallery/portfolio/8.jpg" alt="portfolio images">
                        <div class="portfolio__hover">
                            <div class="portfolio__action">
                                <ul class="portfolio__list">
