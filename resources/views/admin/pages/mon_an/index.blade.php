                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input tabindex="1" class="form-control" id="ma_mon_an" name="ma_mon_an" type="text" placeholder="Nhập vào mã Món Ăn">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input tabindex="2" class="form-control" id="ten_mon_an" name="ten_mon_an" type="text" placeholder="Nhập vào tên Món Ăn">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input class="btn btn-primary" type="button" id="hinh_anh" data-input="thumbnail" data-preview="holder" value="Upload">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label">Đơn giá khuyến mãi</label>
                                                <input tabindex="4" class="form-control" id="don_gia_khuyen_mai_edit" name="don_gia_khuyen_mai_edit"
                                                    type="number" placeholder="Nhập vào đơn giá khuyến mãi">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
